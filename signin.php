...
<div class="user">
    ...
    <form class="form">
		...
		<div class="form__group">
            <input type="text" name = "mail" placeholder="School E-mail" class="form__input" />
        </div>
		<div class="form__group">
            <input type="text" name="classpwd" placeholder="Class Password" class="form__input" />
        </div>
        <div class="form__group">
		...
		<button class="btn" name = "signup-submit" type="button">Sign up!</button><br>
